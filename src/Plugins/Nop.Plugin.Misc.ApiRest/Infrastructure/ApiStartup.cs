...
using Nop.Plugin.Misc.ApiRest.Authorization.Policies;
using Nop.Plugin.Misc.ApiRest.Authorization.Requirements;
using Nop.Plugin.Misc.ApiRest.Configuration;
using Nop.Plugin.Misc.ApiRest.Delta;
using Nop.Web.Framework.Infrastructure.Extensions;
using Swashbuckle.AspNetCore.SwaggerGen;

namespace Nop.Plugin.Misc.ApiRest.Infrastructure
{
	...
	public class ApiStartup : INopStartup
	{
		public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
		{
			...
			if (apiConfigSection != null)
			{
                ...
                Singleton<AppSettings>.Instance.Update(new List<IConfig>
                {
                    apiConfig
                });
				...
				a =>
				{
					...
					// swagger configuration
					{
						...
						a.UseSwaggerUI(c =>
						{
							...
							c.SwaggerEndpoint("/api/swagger/v1/swagger.json", "Nop.Plugin.Misc.ApiRest v4.60");
