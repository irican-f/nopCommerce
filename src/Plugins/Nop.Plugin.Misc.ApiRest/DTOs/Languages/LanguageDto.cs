...
namespace Nop.Plugin.Misc.ApiRest.DTO.Languages
{
    ...
    public class LanguageDto : BaseDto
    {
        ...
        /// <summary>
        ///     Gets or sets the identifier of the default currency for this language; 0 is set when we use the default currency
        ///     display order
        /// </summary>
